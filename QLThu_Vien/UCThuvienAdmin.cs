...
{
    public partial class UCThuvienAdmin : UserControl
    {
            private static UCThuvienAdmin _Instance;
            public static UCThuvienAdmin Instance
            {
                get
                {
                    if (_Instance == null)
                    {
                        _Instance = new UCThuvienAdmin();
                    }
                    return _Instance;
                }
            }
        public UCThuvienAdmin()
        {
            InitializeComponent();
            load();
        }
